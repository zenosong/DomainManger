    ...
    var Userend = {
        ...
        init: function () {
            ...
            $(document).on('click', '.btn-dialog,.dialogit', function (e) {
                ...
                var url = Userend.api.replaceids(that, $(that).data("url") || $(that).attr('href'));
                ...
                if (typeof options.confirm !== 'undefined') {
                    ...
                    window[$(that).data("window") || 'self'].Userend.api.open(url, title, options);
                }
                return false;
            });
            ...
            $(document).on('click', '.btn-addtabs,.addtabsit', function (e) {
                ...
                if (typeof options.confirm !== 'undefined') {
                    Layer.confirm(options.confirm, function (index) {
                        Userend.api.addtabs(url, title, icon);
                        Layer.close(index);
                    });
                } else {
                    Userend.api.addtabs(url, title, icon);
