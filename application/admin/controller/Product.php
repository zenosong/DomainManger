    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                $params['extend'] = json_decode($params['extend'], true);
                $params['models'] = json_decode($params['models'], true);
                ...
                try {
                    ...
                    if (!empty($models)) {
                        $this->model->models()->saveAll(array_map(function ($item) {
                            $item['product_id'] = $this->model->id;
                            return $item;
                        }, $models));
                    }
                    Db::commit();
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try {
                    ...
                    if (!empty($models)) {
                        $row->models()->make($models)->saveAll($models);
                    }
                    Db::commit();
                } catch (ValidateException $e) {
                    Db::rollback();
